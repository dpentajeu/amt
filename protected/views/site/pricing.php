    ...
    <div id="content" class="wrap">                                           
        ...
        <div class="marginBottom30 clearFix">
            ...
            <div class="col3-4">
                ...
                <h2 class="lead-in">FXCM has execution and pricing options to suit all types of traders.  Account and execution types include: No Dealing Desk execution, dealing desk execution, and the Active Trader spread + commission cost structure.  To see spreads for <strong>FXCM’s 56 currency pairs</strong>, register for a practice account below.</h2>
                ...
                On the Dealing Desk execution model FXCM can act as the dealer on some currency pairs. There are also back up liquidity providers that fill in whenever FXCM does not act as the dealer. Please note that FXCM’s Dealing Desk employs fewer liquidity providers than the No Dealing Desk (NDD) execution option.  FXCM does not guarantee that quotes, prices, or spreads will always be better on one form of execution as compared to the other.  Customers should consider many factors when deciding which execution type best suits their needs (e.g., conflict of interest, trading style or strategy, etc.).  For more information, see our <a href="/legal/trading-execution-risks/" onclick="s_objectID=&quot;http://www.fxcm.com/legal/trading-execution-risks/_1&quot;;return this.s_oc?this.s_oc(e):true">Execution Risks</a>.</p>
                    <p class="note"><strong>Advertised Spreads:</strong> FXCM spreads are variable. The spreads listed here were derived from the time-weighted average of the spreads from April 7, 2013&nbsp;to April 19, 2013. Advertised spreads may not be applicable to client accounts of referring brokers. FXCM strives to provide traders with tight, competitive spreads; however, there may be instances when market conditions cause spreads to widen beyond the spreads displayed here. For additional information, <a href="/legal/trading-execution-risks/" onclick="s_objectID=&quot;http://www.fxcm.com/legal/trading-execution-risks/_2&quot;;return this.s_oc?this.s_oc(e):true">click here</a>.</p>    
