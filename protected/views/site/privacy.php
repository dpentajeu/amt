    ...
    <div id="content" class="wrap">                                           
        ...
        <div class="marginBottom30 clearFix">
            ...
            <div class="col1-4">
                ...
                <ul>                    
                    <li>
                        <a href="<?= $baseUrl; ?>/privacy" class="more">Privacy Policy</a>
                    </li>
                    <li>
                        <a href="<?= $baseUrl; ?>/terms" class="more">Terms of use</a>
                    </li>
                </ul>
            ...
            <div class="col3-4">
                <h2 class="separate">Privacy Policy</h2>
                <p style="text-align:justify">
                    ...
                    <h3>Restriction of responsibility</h3>
