    ...
    <div id="content" class="wrap">                                           
        ...
        <div class="marginBottom30 clearFix">
            ...
            <div class="col3-4">
                ...
                <h2 class="lead-in">Auto Matrix Traders Limited, is one of the leading provider of foreign exchange trading (currency trading) and related services to retail and institutional customers.</h2>
