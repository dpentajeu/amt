    ...
    <div id="content" class="wrap">                                           
        ...
        <div class="marginBottom30 clearFix">
            ...
            <div class="col3-4">
                ...
                <h2 class="lead-in">AMT Market Inc., is one of the leading world-wide providers of foreign exchange trading (currency trading) and related services to retail and institutional customers.</h2>
                ...
                <p>One of the advantages of our No Dealing Desk model is that we benefit from successful traders given that we make money on a per trade basis. For this reason, AMT focuses heavily on providing educational services to our clients to help them become better traders. Through <a href="#">DailyFX.com</a>, AMT offers free news and market research, on-demand educational videos, live instructor sessions, and ongoing trading support by the course instructors.</p>
                <h3>International Offices</h3>
                <p>AMT Market is regulated and has offices in a number of global jurisdictions including: the United States, the United Kingdom, Hong Kong, France, Italy, Germany, Greece, Australia, and Japan. With offices, partners, and affiliates in the major financial centers of the world, we are uniquely positioned to provide exceptional service to forex traders around the world. <a href="#">View AMT's International Offices.</a></p>
                <h3>Investor Protection</h3>
                <p>AMT Market takes regulation and financial transparency very seriously, which also means that we meet strict financial standards, including capital adequacy requirements. As a vocal advocate of financial services regulation and increased investor protection, AMT's companies are registered with and regulated by some of the most respected regulatory bodies in the world. The U.S. regulatory framework is widely regarded as one of the best in the world for investor protection. <a href="#">View AMT's Financials.</a></p>
                <h3>Industry Recognition</h3>
                <p>AMT Market has received numerous awards from the forex trading and investment community, including <strong>Overall Client Satisfaction</strong> from <em>Investment Trends</em> (2012), <strong>Best Currency Broker</strong> from <em>Shares</em> (2008), <strong>Best Retail Foreign Exchange Platform</strong> from <em>FX Week</em> (2009 and 2010) and <strong>Best Foreign Exchange Specialist</strong> from <em>Technical Analysis of Stocks &amp; Commodities</em> (2008).</p>
