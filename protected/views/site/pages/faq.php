    ...
    <div id="content" class="wrap">                                           
        ...
        <div class="marginBottom30 clearFix">
            ...
            <div class="col3-4">
                ...
                <p>Because you are always comparing one currency to another, forex is quoted in pairs.  This may seem confusing at first, but it is actually pretty straightforward.  For example, the EUR/USD at 1.4022 shows how much one euro (EUR) is worth in us dollars (USD).</p>
                <h3>What is a lot?</h3>
                <p>A lot is the smallest trade size available.  FXCM accounts have a standard lot size of 1,000 units of currency.  Account holders can however place trades of different sizes, so long as they are in increments of 1,000 units like, 2,000, 3,000, 15,000, 112,000 etc.</p>
                <h3>What is a pip?</h3>
